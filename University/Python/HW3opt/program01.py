...
def ex1(ftesto,a,b,n):
	...
	for x in file_string:
		...
		if a <= len(value) <= b:
			count_sottosequenza = file_string.count(value)
...
if __name__ == '__main__':
	print(ex1('01010010010001000111101100001010011001111000010010011110010000000', 2, 4, 20))
    # pass
